...
const topic = "lines1";
const textThatHelps = "The slope-intercept form of a linear equation is y=mx+b.";
const textThatHelps2 = "The slope, or rate of change, of the line is represented by m. The y-intercept, or the y-value where the line crosses the y-axis, is represented by b.";
const textThatHelps3 = "Look at the give equation. Using the form y=mx+b, what variables match to which values?";
...
function setQuestion() {
    ...
    const isSlope = Math.random() < 0.5;
    const correctAnswerNum = Math.floor(Math.random() * (answerAmount-1));
    if (isSlope){
        answer = num1;
        document.getElementById("QUESTION_TEXT").innerText = "What is the slope of the equation above?";
    }
    else {
        answer = num2;
        document.getElementById("QUESTION_TEXT").innerText = "What is the y-intercept of the equation above?";
    }
    var optionArray = getRandom(answerAmount, 10, answer);
    document.getElementById('PROBLEM_TEXT').innerText = "y=" + num1 + "x+" + num2;
